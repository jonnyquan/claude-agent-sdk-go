...
type TaskUpdatedMessage = claudesdk.TaskUpdatedMessage
type TaskUpdatedStatus = claudesdk.TaskUpdatedStatus
type TaskUsage = claudesdk.TaskUsage
type ModelUsage = claudesdk.ModelUsage
...
const (
	...
	TerminalReasonCompleted         = claudesdk.TerminalReasonCompleted
	TerminalReasonMaxTurns          = claudesdk.TerminalReasonMaxTurns
	TerminalReasonAbortedStreaming  = claudesdk.TerminalReasonAbortedStreaming
	TerminalReasonAbortedTools      = claudesdk.TerminalReasonAbortedTools
